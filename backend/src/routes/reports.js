...
router.get('/revenue', auth, async (req, res) => {
  try {
    ...
    const where = {
      status: 'COMPLETED',
      ...(from && to
        ? { createdAt: { gte: new Date(from + 'T00:00:00+07:00'), lte: new Date(to + 'T23:59:59+07:00') } }
        : from ? { createdAt: { gte: new Date(from + 'T00:00:00+07:00') } }
        : to   ? { createdAt: { lte: new Date(to + 'T23:59:59+07:00') } }
        : {})
    };
