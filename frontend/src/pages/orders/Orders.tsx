                ...
                <tr key={o.id} className={`hover:bg-gray-50 ${selectedIds.has(o.id) ? 'bg-blue-50' : ''}`}>
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-2">
                      ...
                      <button title="Xóa đơn hàng" onClick={() => { if (confirm(`Xóa đơn hàng ${o.orderCode}?\nThao tác này không thể hoàn tác.`)) delOrder(o.id) }} className="text-red-400 hover:text-red-600"><Trash2 size={15} /></button>
                    </div>
                  </td>
                </tr>
              ))}
